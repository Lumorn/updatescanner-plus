...
const translations = {
  en: {
    ...
    'footer.menu': 'Menu',
    'popup.search.label': 'Search updates',
    'popup.search.placeholder': 'Search updates',
    'popup.filter.label': 'Filter updates',
    'popup.filter.all': 'All',
    'popup.filter.new': 'New',
    'popup.filter.error': 'Error',
    'popup.filter.changed': 'Changed',
    'popup.status.new': 'New',
    'popup.status.error': 'Error',
    'popup.status.changed': 'Changed',
    'popup.empty.default': 'No updates available.',
    'popup.empty.filtered': 'No matches for these filters.',
  ...
  de: {
    ...
    'footer.sidebar': 'Sidebar',
    'footer.menu': 'Menü',
    'popup.search.label': 'Updates durchsuchen',
    'popup.search.placeholder': 'Updates durchsuchen',
    'popup.filter.label': 'Updates filtern',
    'popup.filter.all': 'Alle',
    'popup.filter.new': 'Neu',
    'popup.filter.error': 'Fehler',
    'popup.filter.changed': 'Geändert',
    'popup.status.new': 'Neu',
    'popup.status.error': 'Fehler',
    'popup.status.changed': 'Geändert',
    'popup.empty.default': 'Keine Updates verfügbar.',
    'popup.empty.filtered': 'Keine Treffer für diese Filter.',
